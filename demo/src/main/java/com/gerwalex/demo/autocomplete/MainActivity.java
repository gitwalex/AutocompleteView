package com.gerwalex.demo.autocomplete;
...
import com.gerwalex.autocomplete.policy.AutocompletePolicy;
import com.gerwalex.autocomplete.policy.CharPolicy;
import com.gerwalex.autocomplete.view.Autocomplete;
import com.gerwalex.autocomplete.view.AutocompleteCallback;
import com.gerwalex.autocomplete.view.AutocompletePresenter;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.multi_button:
                ...
                Toast
                        .makeText(this, "Sent!", Toast.LENGTH_SHORT)
                        .show();
                break;
        }
    }
    ...
    private void setupMaleFemaleAutocomplete() {
        ...
        AutocompleteCallback<User> callback = new AutocompleteCallback<User>() {
            ...
            public boolean onPopupItemClicked(@NonNull Editable editable, @NonNull User item) {
                ...
                editable.setSpan(new StyleSpan(Typeface.BOLD), 0, item
                        .getFullname()
        ...
        maleFemaleAutocomplete = Autocomplete
                .<User>on(edit)
                .with(elevation)
    ...
    private void setupMentionsAutocomplete() {
        ...
        mentionsAutocomplete = Autocomplete
                .<User>on(edit)
                .with(elevation)
                .with(backgroundDrawable)
                .with(policy)
