package com.gerwalex.autocomplete.view;
...
public final class Autocomplete<T> implements TextWatcher, SpanWatcher {
    ...
    private Autocomplete(Builder<T> builder) {
        ...
        popup.setElevation(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, builder.elevationDp, source
                .getContext()
                .getResources()
                .getDisplayMetrics()));
        // popup dimensions
        ...
        source
                .getText()
                .setSpan(this, 0, source.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
    ...
    public void showPopup(@NonNull CharSequence query) {
        if (isPopupShowing() && lastQuery.equals(query.toString())) {
            return;
        }
